                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select name="cat_id" id="category" class="form-control @error('cat_id') is-invalid @enderror" style="display: none;">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="is_borrowable" name="is_borrowable" value="1" {{ old('is_borrowable') ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="room_id" id="room_id" class="form-control @error('room_id') is-invalid @enderror" style="display: none;">
